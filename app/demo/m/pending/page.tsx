import { getPendingExtractionsDemo } from "@/lib/demo/actions";
import { PendingList } from "@/components/mobile/pending-list";

export const dynamic = "force-dynamic";

export default async function DemoPendingPage() {
  const items = await getPendingExtractionsDemo();
  ...
  return (
    <PendingList
      items={summary}
      basePath="/demo/m/pending"
      captureHref="/demo/m"
    />
  );
}

function collectMentionTexts(raw: {
  observations?: Array<{ primary_mention?: { text?: string } }>;
} | null): string[] {
